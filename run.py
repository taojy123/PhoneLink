...
import sys
import webbrowser
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "phonelink.settings")
#these pertain to your application
import phonelink.wsgi
import phonelink.urls
import phonelink.settings
import phonelink.models
import phonelink.views
